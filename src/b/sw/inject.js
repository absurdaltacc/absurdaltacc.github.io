...
(function(){
  ...
  if(!O)return;
  function tc(){try{return window.top&&window.top.__TILT_WEBRTC_TURN__}catch(e){}try{return window.parent&&window.parent.__TILT_WEBRTC_TURN__}catch(e){}return window.__TILT_WEBRTC_TURN__||null}
...
(function(){
  ...
  function W(cfg,cs){
    ...
    try{var add=pc.addEventListener.bind(pc);pc.addEventListener=function(type,fn,opt){if(type==='icecandidate'&&typeof fn==='function'){var f=function(e){if(relay(e&&e.candidate))return fn.call(this,e)};fn.__tiltRelay=f;return add(type,f,opt)}return add(type,fn,opt)}}catch(e){}
    try{var rem=pc.removeEventListener.bind(pc);pc.removeEventListener=function(type,fn,opt){return rem(type,fn&&fn.__tiltRelay||fn,opt)}}catch(e){}
    return pc
  }
  W.prototype=O.prototype;
  try{Object.setPrototypeOf(W,O)}catch(e){}
...
(function(){
  ...
  function pS(w,u){if(!w||typeof w.postMessage!=='function')return false;try{w.postMessage({type:'tilt-prefetch',url:u});return true}catch(e){return false}}
  async function pf(url){
    ...
    try{if(window.top&&window.top!==window){window.top.postMessage({type:'tilt-prefetch-bridge',url:url},location.origin);sent[url]=1;cnt++;return}}catch(e){}
  }
  function qP(ev){
...
(function(){
  ...
  function pI(){
    try{var ls=document.querySelectorAll('link[rel~="icon"], link[rel*="icon"]');for(var i=0;i<ls.length;i++){var h=ls[i].getAttribute('href');if(!h)continue;try{return new URL(h,location.href).href}catch(e){}}try{return new URL('/tilt-favicon.svg',location.href).href}catch(e){}return null}catch(e){return null}
  }
  async function sM(){
