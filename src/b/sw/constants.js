...
const SHELL_CACHE = "tilt-shell-" + BUILD_FINGERPRINT;
const RUNTIME_CACHE = "tilt-runtime-" + BUILD_FINGERPRINT;
const PREFETCH_CACHE = "tilt-prefetch-nav-" + BUILD_FINGERPRINT;
const LARGE_CACHE = "tilt-large-files-" + BUILD_FINGERPRINT;
...
const PREFETCH_HEADER = "x-tilt-prefetch";
