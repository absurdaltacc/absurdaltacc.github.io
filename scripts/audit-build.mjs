...
const sensitiveTerm = "(?:games?|anime|proxy|rivet|folio|tilt)";
...
const signalLimits = [
  ...
  { label: "tilt", pattern: /tilt/gi, maximum: 20 },
];
...
if (packageMetadata.name !== "tilt" || packageMetadata.version !== "0.1.0") {
  fail("application metadata does not match the Tilt release");
}
